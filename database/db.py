...
def create_tables():
    ...
    # Tabela de usuários com a nova coluna 'is_active'
    # is_active: 1 para ativo (padrão), 0 para inativo/desativado
    cursor.execute("""
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS approvals (
            ...
            order_id INTEGER,
            user_id INTEGER,
            status TEXT NOT NULL, -- 'aprovado' ou 'rejeitado'
            comments TEXT,
...
def seed_main_admin():
    ...
    # Insere ou substitui o admin, garantindo que ele esteja sempre ativo
    cursor.execute("""
